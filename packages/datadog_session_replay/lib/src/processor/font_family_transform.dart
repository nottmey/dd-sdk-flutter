...
/// Web-style fallback stack aligned with native iOS Session Replay intent;
/// uses unquoted `Roboto` so smart-mode round-trip matches [formatFamilyForCssList].
@visibleForTesting
const String kIosParityFontStack =
...
class FontFamilyTransform {
  ...
  SRTextWireframe rewrite(SRTextWireframe wireframe) {
    final nextFamily = apply(wireframe.textStyle.family);
